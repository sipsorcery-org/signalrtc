...
dotnet ef dbcontext scaffold --use-database-names -o DataAccess/AutoGen --context SIPAssetsDbContext --namespace devcall.DataAccess -f "Data Source=localhost;Initial Catalog=SIPAssets;Persist Security Info=True;User ID=appuser;Password=password" Microsoft.EntityFrameworkCore.SqlServer

and once the connection string is stored in the user secrets store:

dotnet ef dbcontext scaffold --use-database-names -o DataAccess/AutoGen --context SIPAssetsDbContext --namespace devcall.DataAccess -f Name=ConnectionStrings.SIPAssets Microsoft.EntityFrameworkCore.SqlServer
...
dotnet ef dbcontext scaffold --use-database-names -o DataAccess/AutoGen --context SIPAssetsDbContext --namespace devcall.DataAccess -f "Data Source=AppData/sipassets.db" Microsoft.EntityFrameworkCore.Sqlite
